            ...
            gap-8 sm:gap-12 items-center">
                ...
                className='text-center lg:text-left relative order-1 lg:order-2'>
                    ...
                    <p className={`text-sm sm:text-base lg:text-lg xl:text-xl mb-6
                        sm:mb-8 leading-relaxed bg-linear-to-r from-orange-900/10
                        to-orange-900/5 p-4 sm:p-6 rounded-xl sm:rounded-2xl
                    ...
                    sm:gap-6 lg:gap-8 mb-6 sm:mb-8'> */}
                        ...
                        data-aos-delay='600'>
                            <div className='text-2xl sm:text-3xl lg:text-4xl font-bold
                            text-orange-400'>100+</div>
                            <div className={`text-xs sm:text-sm lg:text-base
                            ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>Project Complement</div>
                        </div>
                    </div> */}
                    <button 
                    className= {`w-full sm:w-auto border-2 border-orange-500 inline-flex 
                    items-center justify-center py-2 px-4 sm:px-6 hover:shadow-[0_0_40px_rgba(255,165,0,0.7)] 
