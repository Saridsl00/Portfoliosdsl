...
const Skill = ({ darkMode }) => {
    const Skill =[
        ...
        {name: 'MySQL', icon:mysql, level: 95,
            color:'from-orange-500 to-blue-85'},
            ...
            <div className='py-14 relative overflow-hidden'>
                <div className='container px-5 py-14 mx-auto'>
                    <div className='text-center mb-20' data-aos='fade-up'>
                        ...
                        style={{color: darkMode ? 'white' : '#1f2937'}}> My 
                        <span 
                        style={{
                    ...
                    data-aos-delay='200'>
                        {Skill.map((skill, index) => (
                            ...
                            data-aos='fade-up'
                            data-aos-delay={`$300 + index 8 100`}>
                                <div
                                style={{
                                    background : darkMode 
                                ...
                                transition-all duration-300 hover:-translate-y-2 group hover:shadow-[0_0_30px_rgb(255, 165,0,0,0.15)]'>
                                    <div className='flex items-center mb-6'>
                                        ...
                                        <div className='mb-2 flex justify-between item-center'>
                                            <span
